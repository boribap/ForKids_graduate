...
public class CameraTest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            Debug.LogWarningFormat("Show Origin image.");
            OpenCVInterop.Show();
            ...
            unsafe
            {
                ...
                {
                    Debug.LogWarningFormat("Detect Start.");
                    //outFaces
                    ...
                    var file = "C:/Users/dqf96/Desktop/New Unity Project/Assets/cropimg.png";

                    //Tensor 불러오는 소스
                    TFSession.Runner runner;

                    TextAsset graphModel = Resources.Load("tf_model_191120(19)") as TextAsset;
    ...
    {
        [DllImport("saveCrop", EntryPoint = "Init")]
        internal static extern int Init();

        [DllImport("saveCrop", EntryPoint = "SetScale")]
        internal static extern int SetScale(int downscale);

        [DllImport("saveCrop", EntryPoint = "Show")]
        internal static extern void Show();

        [DllImport("saveCrop", EntryPoint = "Detect")]
