...
public class ResultSceneScript : MonoBehaviour
{
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            unsafe
            {
                fixed (CvCircle* outFaces = _faces)
                {
                    ...
                    TextAsset graphModel = Resources.Load("tf_model_191203_07") as TextAsset;
            ...
            webcamTexture.Stop();
            byte[] byteArray = File.ReadAllBytes(@"C:\Users\bsww201\Desktop\New Unity Project\New Unity Project\Assets\cropimg.png");
    ...
    {
        [DllImport("FinalDLL", EntryPoint = "Init")]
        internal static extern int Init();

        [DllImport("FinalDLL", EntryPoint = "SetScale")]
        internal static extern int SetScale(int downscale);

        [DllImport("FinalDLL", EntryPoint = "Show")]
        internal static extern void Show();

        [DllImport("FinalDLL", EntryPoint = "Detect")]
